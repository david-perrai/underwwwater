...
export class InitDatabase1770155863498 implements MigrationInterface {
  name = 'InitDatabase1770155863498';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."dives_diverrole_enum" AS ENUM('diver', 'instructor', 'monitor')`,
    );
    await queryRunner.query(
      `CREATE TABLE "dives" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "date" TIMESTAMP NOT NULL, "totalTime" integer NOT NULL, "maxDepth" double precision NOT NULL, "diverRole" "public"."dives_diverrole_enum" NOT NULL DEFAULT 'diver', "divingEnvironmentId" integer NOT NULL, "ownerId" integer NOT NULL, CONSTRAINT "PK_206d8db169538184f5e86c5752d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "users" ("id" SERIAL NOT NULL, "email" character varying(180) NOT NULL, "username" character varying(255) NOT NULL, "roles" text NOT NULL DEFAULT 'ROLE_USER', "password" character varying NOT NULL, "refreshToken" character varying, "avatar" character varying(255), "subscribedAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "activatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "public"."dives_diverrole_enum"`);
